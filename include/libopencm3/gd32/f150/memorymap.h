...
//#define DMA2_BASE			(PERIPH_BASE_AHB1 + 0x08400)
...
/* PERIPH_BASE_AHB1 + 0xb400 (0x4002 3400 - 0x4002 7FFF): Reserved */
//#define ETHERNET_BASE			(PERIPH_BASE_AHB1 + 0x10000)
/* PERIPH_BASE_AHB1 + 0x18000 (0x4003 0000 - 0x4FFF FFFF): Reserved */
//#define USB_OTG_FS_BASE			(PERIPH_BASE_AHB1 + 0xffe8000)
...
//#define GPIO_PORT_E_BASE		(PERIPH_BASE_AHB2 + 0x1800)
#define GPIO_PORT_F_BASE		(PERIPH_BASE_AHB2 + 0x1400)
//#define GPIO_PORT_G_BASE		(PERIPH_BASE_AHB2 + 0x2000)
