 ...
 *
 * @brief <b>Defined Constants and Types for the GD32F150 Reset and Clock
 * Control</b>
 *
...
#define RCC_CFGR4                               MMIO32(RCC_BASE + 0x80) /*(**)*/
#define RCC_ACR                                 MMIO32(RCC_BASE + 0xf8) /*(**)*/
#define RCC_ARCR                                MMIO32(RCC_BASE + 0xfc) /*(**)*/
...
#define RCC_CFGR_PLLMUL				(0x20F << RCC_CFGR_PLLMUL_SHIFT)
...
@ingroup GD32F150_rcc_defines

@{*/
#define RCC_CFGR_MCO_SHIFT			24
#define RCC_CFGR_MCO_MASK			0x7
#define RCC_CFGR_MCO_NOCLK			0x0
#define RCC_CFGR_MCO_HSI14                      0x1
...
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL17           0x200
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL18           0x201
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL19           0x202
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL20           0x203
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL21           0x204
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL22           0x205
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL23           0x206
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL24           0x207
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL25           0x208
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL26           0x209
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL27           0x20a
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL28           0x20b
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL29           0x20c
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL30           0x20d
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL31           0x20e
#define RCC_CFGR_PLLMUL_PLL_CLK_MUL32           0x20f
/**@}*/
...
@{*/
#define RCC_AHBRSTR_TSIRST			(1 << 24)
...
#define RCC_CFGR3_ADCSEL                        (1 << 8)
#define RCC_CFGR3_CECSEL                        (1 << 6)
#define RCC_CFGR3_USART1SEL_SHIFT               0
#define RCC_CFGR3_USART1SEL                     (3 << RCC_CFGR3_USART1SEL_SHIFT)

/* --- RCC_CR2 values ------------------------------------------------------ */

#define RCC_CR2_HSI14CALIB_SHIFT                8
#define RCC_CR2_HSI14CALIB                      (0xff << RCC_CR2_HSI14CALIB_SHIFT)
#define RCC_CR2_HSI14ADJ_SHIFT                  3
#define RCC_CR2_HSI14ADJ                        (0x1f << RCC_CR2_HSI14ADJ_SHIFT)
...
enum rcc_osc {
	RCC_PLL, RCC_HSI14, RCC_HSE, RCC_HSI, RCC_LSE, RCC_LSI
};
...
enum rcc_periph_clken {
	...
	RCC_CRC		= _REG_BIT(0x14, 6),/*VNC*/
        ...
        RCC_GPIOF       = _REG_BIT(0x14, 22),/*VNC*/
        RCC_TSI         = _REG_BIT(0x14, 24),/*VNC*/
...
enum rcc_periph_rst {
	...
	/* AHB peripherals */
        RST_GPIOA       = _REG_BIT(0x28, 17),/*VNC*/
        RST_GPIOB       = _REG_BIT(0x28, 18),/*VNC*/
        RST_GPIOC       = _REG_BIT(0x28, 19),/*VNC*/
        RST_GPIOD       = _REG_BIT(0x28, 20),/*VNC*/
        RST_GPIOF       = _REG_BIT(0x28, 22),/*VN-*/
        RST_TSI         = _REG_BIT(0x28, 24),/*VN-*/
